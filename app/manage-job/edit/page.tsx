      ...
      <div className="w-full relative p-10 overflow-y-scroll h-screen">
        <div className="">
          <h1 className="text-3xl font-bold">
            <span className="cursor-pointer" onClick={() => router.back()}>Manage jobs</span> &gt; Edit
          </h1>
        </div>
        <hr className="my-4" />
        <div className="flex flex-col gap-8">
          ...
          <div className="gap-y-3 flex flex-col">
            ...
            <textarea
              ...
              className="w-1/2 border h-[153px] border-[#5C5F62] font-medium text-[#5C5F62] rounded-[8px] text-xl p-5"
